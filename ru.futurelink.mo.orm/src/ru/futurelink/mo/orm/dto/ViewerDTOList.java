 ...
 *
 */
public class ViewerDTOList<T extends CommonDTO> extends CommonDTOList<T> {
	 ...
	 * @param DTOclass
	 */
	public ViewerDTOList(IDTOAccessChecker accessChecker, Class<T> DTOclass) {
		super(null, accessChecker, DTOclass);
	}
